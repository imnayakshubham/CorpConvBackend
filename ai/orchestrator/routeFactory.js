// Turns a FeaturePlugin into Express handlers: createAgentHandlers(plugin) → { chat, summarize }.
// Validates the request, wires abort-on-disconnect, extracts context, then hands off to the
// orchestrator. The route file supplies its own auth/limit/quota stack.
