// The SURVEY FeaturePlugin. Field types, system prompt, and the planner/worker/critic
// prompts for the multi-agent build pipeline live here; the harness stays domain-agnostic.
// Tools are in ../tools/survey/. See ../types/types.js for the contract.

const { extractJson, clamp } = require('../core/json');
const { extractUserText, lastUserMessage } = require('../core/messages');
const tools = require('../tools/survey');
const { FIELD_TYPES, FIELD_TYPE_HINTS } = require('../tools/survey/schema');
